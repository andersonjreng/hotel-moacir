...
export class Endpoints {
  ...
  public baseQuartos(): string {
    return `${this.baseServidor}/quartos`;
  }

  public baseQuartoPorId(id: number): string {
    return `${this.baseServidor}/quartos/${id}`;
  }

  public baseHospedes(): string {
    return `${this.baseServidor}/hospedes`;
  }

  public baseAgendamentos(): string {
    return `${this.baseServidor}/agendamentos`;
  }
